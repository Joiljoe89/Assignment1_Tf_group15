...
cl=3
X, Y = data('/home/muralikrishna/Desktop/DL_project/Songs_data/singer_identification/train.dat')
...
r = model.fit(X, Y, batch_size=100, epochs=3, validation_split = 0, verbose=1,shuffle=True)


model.save('/home/muralikrishna/Desktop/DL_project/Models/singer_MFECCNN1.h5')
