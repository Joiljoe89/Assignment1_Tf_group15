...
@author: muralikrishna  This program is for Confusion matrix 5 singers
"""
...
#########################################################################################################################################
indir = '/home/groupdl2/singer_identification/1Alka_cut/'  # Directory of class1 wav file
...
for root, dirs, filenames in os.walk(indir):
    for f in sorted(filenames):
        ...
        x = (x - mu) / std
        x = x.reshape(x.shape[0], 11, 40, 1)  # We have 40 MFEC   or20 MFCC/frame with cl=2
        ...
        if P1==0:
            ...
            print('This is YesuDas')
            c5=c5+1
            
            
print('Total files predicted as Alka:',c1,' As Lata:',c2,' As Rafi: ',c3,' As Shreya: ',c4,' As YesuDas',c5)
CM[0,0]=c1
CM[1,0]=c2
CM[2,0]=c3
CM[3,0]=c4
...
indir = '/home/groupdl2/singer_identification/2Lata_cut/'  # Directory of class1 wav file
...
indir = '/home/groupdl2/singer_identification/4Shreya_cut/'  # Directory of class1 wav file
...
indir = '/home/groupdl2/singer_identification/5Yesu_cut/'  # Directory of class1 wav file
