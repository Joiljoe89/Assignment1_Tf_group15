...
X, Y = data('/home/groupdl2/singer_identification/441MFECtrain5.dat')
...
r = model.fit(X, Y, batch_size=100, epochs=10, validation_split = 0, verbose=1,shuffle=True)


model.save('/home/groupdl2/singer_identification/singer_MFECCNN5class441.h5')
