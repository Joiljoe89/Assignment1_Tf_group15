...
model.add(Conv2D(128, kernel_size=(11, 9), activation='relu', input_shape=(21, 40, 1)))
model.add(MaxPooling2D(pool_size=(1, 4)))

model.add(Conv2D(256, kernel_size=(5, 6), activation='relu'))
...
plt.legend()
plt.show()
plt.savefig('figures/CNN/acc/keras_CNN_D_512.png' , bbox_inches = 'tight')
...
plt.legend()
plt.show()
plt.savefig('figures/CNN/loss/keras_CNN_D_512.png' , bbox_inches = 'tight')

model.save('models/CNN/keras_CNN_D_512.h5')
