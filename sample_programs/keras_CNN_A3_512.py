...
model = Sequential()
model.add(Conv2D(64, kernel_size=(1, 3), activation='relu', input_shape=(21, 40, 1)))
...
model.add(Conv2D(256, kernel_size=(9, 3), activation='relu'))
...
plt.legend()
plt.show()
plt.savefig('figures/CNN/acc/keras_CNN_A3_512.png' , bbox_inches = 'tight')
...
plt.legend()
plt.show()
plt.savefig('figures/CNN/loss/keras_CNN_A3_512.png' , bbox_inches = 'tight')

model.save('models/CNN/keras_CNN_A3_512.h5')
